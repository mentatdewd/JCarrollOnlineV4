...
namespace JCarrollOnline.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        private const string _getUserByIdActionName = "GetUserById";
        private const string _getRoleByIdActionName = "GetRoleById";
        ...
        [HttpGet("users/{id}", Name = _getUserByIdActionName)]
        [ProducesResponseType(200, Type = typeof(UserViewModel))]
        ...
        public async Task<IActionResult> UpdateUser(string id, [FromBody] UserEditViewModel user)
        {
            ...
            Task<AuthorizationResult> assignRolePolicy = _authorizationService.AuthorizeAsync(User, (user.Roles, currentRoles), Policies.AssignAllowedRolesPolicy);
        ...
        public async Task<IActionResult> Register([FromBody] UserEditViewModel user)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    return CreatedAtAction(_getUserByIdActionName, new { id = userVM.Id }, userVM);
                }
        ...
        [HttpGet("roles/{id}", Name = _getRoleByIdActionName)]
        ...
        public async Task<IActionResult> CreateRole([FromBody] RoleViewModel role)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    return CreatedAtAction(_getRoleByIdActionName, new { id = roleVM.Id }, roleVM);
                }
